...
export default function ExercisesScreen() {
  ...
  return <Screen title="THƯ VIỆN BÀI TẬP" subtitle="Tra cứu kỹ thuật và xây dựng giáo án." onBack={() => router.canGoBack() ? router.back() : router.replace('/(app)/(tabs)/workouts')}>
